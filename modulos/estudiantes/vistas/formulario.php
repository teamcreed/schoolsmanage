...
<div class="container-fluid contenedor" id="formulario">
    <form action="index.php?com=<?=$this->ruta?>&task=insertar&ajax=true" method="post" id="<?=$this->form?>" class="manejaform" binder="BindFormEstudiante" callback="<?=$this->form?>">
        <div class="row">
            ...
            <div class="col-lg-4"><input type="text" class="form-control" mensaje="Nombres del alumno.<br>" name="nombre" requerido="true" value="<?=$alumno[nombre]?>" placeholder="Nombres..." id="nombre" /></div>
            <div class="col-lg-2 negrita">Apellidos:</div>
            <div class="col-lg-4"><input type="text" class="form-control" mensaje="Apellidos del alumno.<br>" name="apellido" requerido="true" value="<?=$alumno[apellido]?>" placeholder="Apellidos..." id="apellido" /></div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class='input-group date' id='Fechainicial'>
                    <input type="text" class="form-control" mensaje="Introduzca la fecha de nacimiento.<br>" name="fechanacimineto" requerido="true" value="<?=$alumno[Nacimiento]?>" placeholder="Fecha de nacimiento..." id="fechanacimineto" />
            ...
            <div class="col-lg-4"><input type="text" class="form-control" name="tiposangre" value="<?=$alumno[tiposangre]?>" placeholder="Tipo de sangre" id="tiposangre" /></div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-6">
                <?
                if($edit){
                    ?><input type="text" class="form-control" value="<?=$alumno[REP]?>" readonly=""/></div><?
                }else{
                    ?>
